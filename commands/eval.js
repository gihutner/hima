    ...
    execute(client, message, args) {
        if (message.author.id !== ownerID) {
            ...
            const evaluated = eval(toEval);
             ...
             message.channel.send(inspect(evaluated), {code:"coffeescript"});
            ...
            message.channel.send(error, {code:"coffeescript"}); // send a message in the channel stating there was an error
        }
    }
}
        };
